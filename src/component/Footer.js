...
import clg6 from './images/clg6.jpg';
import clg7 from './images/clg7.jpeg';
import clg8 from './images/clg8.jpeg';
import clg9 from './images/clg9.jpeg';
import clg10 from './images/clg10.jpg';
import clg11 from './images/clg11.jpg';
import './Footer.css';
function Footer()
{
    return(
        <div>
            ...
            <div className='a1'>
                ...
                <hr></hr>
                <div>
                    <h1 className='styling1'>Vision</h1>
                ...
                <div>
                    <h1 className='styling1'>Mission</h1>
                ...
                <hr></hr>
                <div>
                    <h1 className='styling1'>Last Events & News</h1>
                    <p className='text2'>Three days Workshop from 14thto 16th June</p>
                ...
                <hr></hr>
                <div>
                    <p className='text2'>World Environment Day Celebration</p>
                ...
                <hr></hr>
                <div>
                    <p className='text2'>Kannada Rajyotsava Celebration</p>
                ...
                <hr></hr>
                <div>
                    <p className='text2'>Graduation day-2023</p>
                ...
                <hr></hr>
                <div>
                    <p className='text2'>Secura 2k23 : Sports & Extra Curricular Activities</p>
